...
import com.spacester.tweetster.adapter.AdapterComment;
                    ...
                    public void onClick(View v) {
                        ...
                        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                ...
                                if (id == 3){
                                    Intent intent = new Intent(getApplicationContext(), LikedByActivity.class);
                                    intent.putExtra("postId", pId);
                                    startActivity(intent);
                                }

                                if (id == 4){
                                    Intent intent = new Intent(getApplicationContext(), RetweetedByActivity.class);
                                    intent.putExtra("postId", pId);
                                    startActivity(intent);
                                }
