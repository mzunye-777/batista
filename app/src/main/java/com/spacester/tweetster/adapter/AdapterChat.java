...
import com.spacester.tweetster.activity.MediaActivity;
import com.spacester.tweetster.activity.MyProfileActivity;
import com.spacester.tweetster.activity.SearchPostActivity;
import com.spacester.tweetster.activity.StoryChatViewActivity;
...
public class AdapterChat extends RecyclerView.Adapter<AdapterChat.MyHolder>{
    ...
    public void onBindViewHolder(@NonNull AdapterChat.MyHolder holder, int position) {
        ...
        String type = modelChats.get(position).getType();
         String hisId = modelChats.get(position).getReceiver();
        ...
        switch (type) {
            ...
            case "story":
                ...
                holder.media.setVisibility(View.VISIBLE);
                Glide.with(context).asBitmap().centerCrop().load(modelChats.get(position).getTimeStamp()).into(holder.media);
                break;
        }
        ...
        FirebaseDatabase.getInstance().getReference().child("Users").child(modelChats.get(position).getSender()).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if (id == 0){
                            ...
                            String cId = modelChats.get(position).getTimeStamp();
        ...
        holder.media.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (type) {
                    ...
                    case "story": {
                        Intent intent = new Intent(context, StoryChatViewActivity.class);
