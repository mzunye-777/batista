...
import com.spacester.tweetster.activity.CommentLikedByActivity;
import com.spacester.tweetster.activity.CommentRetweetedByActivity;
...
import com.spacester.tweetster.model.ModelComment;
                ...
                public void onClick(View v) {
                    ...
                    popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                            ...
                            if (id == 4){
                                Intent intent = new Intent(context, CommentRetweetedByActivity.class);
