...
import com.spacester.tweetster.activity.EditPostActivity;
import com.spacester.tweetster.activity.LikedByActivity;
import com.spacester.tweetster.activity.MediaActivity;
import com.spacester.tweetster.activity.MyProfileActivity;
import com.spacester.tweetster.activity.RetweetedByActivity;
                ...
                public void onClick(View v) {
                    ...
                    popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                            ...
                            if (id == 4){
                                Intent intent = new Intent(context, RetweetedByActivity.class);
                                intent.putExtra("postId", postList.get(position).getpId());
                                context.startActivity(intent);
                            }
