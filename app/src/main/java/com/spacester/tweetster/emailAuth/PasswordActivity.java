package com.spacester.tweetster.emailAuth;
...
import com.spacester.tweetster.activity.Terms;
...
public class PasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forgot.setOnClickListener(v -> {
            Intent intent = new Intent(PasswordActivity.this, ForgotPasswordActivity.class);
        ...
        button.setOnClickListener(v -> {
            ...
            if (mPassword.isEmpty()){
                ...
                mAuth.signInWithEmailAndPassword(email,mPassword).addOnCompleteListener(PasswordActivity.this, task -> {
